...
public class ConfigControllerIT {
  ...
  @Test
  public void get_configs_returnDataResult() {
    ...
    final ResponseEntity<DataResult<List<ConfigInfo>>> response =
        this.restTemplate.exchange(
  ...
  @Test
  public void upload_config_returnResult() {
    final String accessToken = this.register().getData().accessToken();
  ...
  @Test
  public void get_config_returnDataResult() {
    final String accessToken = this.register().getData().accessToken();
    ...
    final String fileName = "test-config";
    final String url = "http://localhost:" + port + "/v1/configs/" + fileName;

    final ResponseEntity<DataResult<ConfigInfo>> response =
        this.restTemplate.exchange(
            url, HttpMethod.GET, entity, new ParameterizedTypeReference<>() {});
  ...
  @Test
  public void delete_config_returnResult() {
    final String accessToken = this.register().getData().accessToken();
    ...
    final String fileName = "test-config";
    final String url = "http://localhost:" + port + "/v1/configs?name=" + fileName;

    final ResponseEntity<Result> response =
        this.restTemplate.exchange(url, HttpMethod.DELETE, entity, Result.class);
