...
public class PodService {
  ...
  public @NotNull V1Pod create(
      final @NotNull String namespace, final @NotNull V1Pod pod, final @NotNull UUID userUuid)
      throws Exception {
  ...
  public @NotNull V1Pod update(
      final @NotNull String namespace,
      final @NotNull String name,
      final @NotNull V1Pod pod,
      final @NotNull UUID userUuid)
      throws Exception {
    final UserInfo userInfo = this.userService.getUserInfo(userUuid);
    final CoreV1Api coreV1Api = this.apiClientFactory.coreV1Api(userInfo.activeConfig(), userUuid);
    return coreV1Api.replaceNamespacedPod(name, namespace, pod).execute();
  }
  ...
  public void terminalExec(
    ...
    final Exec exec = this.apiClientFactory.exec(userInfo.activeConfig(), userUuid);
